...
public class controlAffichage {
    ...
    public void display(MouseEvent mouseEvent) {
        ...
        for (int i=0;i<h;i++) {
            ...
            int finalI = i;
            sup.setOnAction(e->this.agence.supprimerBien(this.lesbien.get(finalI)));
            Region rg=new Region();
            HBox hBox13= new HBox();
            hBox13.setSpacing(50);

            Button arch=new Button("Archive");
            int finalI1 = i;
            arch.setOnAction(e->this.agence.archiverBien(this.lesbien.get(finalI1)));

            Button modf=new Button("modify");
            int finalI2 = i;
            modf.setOnAction(e->{stageaffich stg =new stageaffich();stg.modiferwindow(this.agence,this.lesbien.get(finalI2));});
            ...
            hBox13.getChildren().addAll(rg,sup,arch,modf,msg);
