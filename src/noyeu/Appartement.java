...
public class Appartement extends Habitable {
   ...
   /* public Appartement(Wilaya wilaya,float superficie,Proprietaire proprietaire,NatureTransaction natureTransaction,int prixPropose,boolean negociable,String description,Date date,String[] urlphoto,int nb_pieces,boolean meuble,int etage,boolean duplex,boolean ascenseur) throws notDuplex,prixNegative
    ...
    public Appartement(Wilaya wilaya,float superficie,Proprietaire proprietaire,
                       NatureTransaction natureTransaction,float prixPropose,boolean negociable,
                       String description,Date date,String[] urlphoto,int nb_pieces,boolean meuble,
                       int etage,boolean duplex,boolean ascenseur)
    {
        super(wilaya, superficie, proprietaire, natureTransaction, prixPropose, negociable, description, date, urlphoto, nb_pieces, meuble);
        this.etage = etage;
        this.duplex = duplex;
    ...
    {
        String s=super.affBien();
        s=s+"Type du l'habitable : Appartement"+"\n";
        s=s+"Les informations supplementaires sur l'apparetement"+"\n";
        s=s+"Nombre d'etage : "+this.etage+"\n";
        if (this.duplex)s=s+"Duplex"+"\n";
        else s=s+"Simplex"+"\n";
        s=s+"Ascenseur : ";
        if (this.ascenseur) s=s+"Oui"+"\n";
        else s=s+"Non"+"\n";
        return s;
