...
/*
    private float calculerPrixGenerale(tpPoo.noyeau.BiensImmobiliers biensImmobiliers)
    ...
    @Override
    public float calculerPrix(tpPoo.noyeau.BiensImmobiliers b) {
        float a=0;
        if (b instanceof tpPoo.noyeau.Appartement)
        {
            a= calculerPrix((tpPoo.noyeau.Appartement)b);
        }
        else if (b instanceof tpPoo.noyeau.Maison)
        {
            a= calculerPrix((tpPoo.noyeau.Maison) b);
        }
        else if (b instanceof tpPoo.noyeau.Inhabitable)
        {
            a= calculerPrix((tpPoo.noyeau.Inhabitable) b);
        }
        else a=b.getPrixPropose();
        return a;
    }

    public float calculerPrix(tpPoo.noyeau.Appartement appartement) {
    ...
    public float calculerPrix(tpPoo.noyeau.Maison maison) {
    ...
    public float calculerPrix(tpPoo.noyeau.Inhabitable inhabitable) {
